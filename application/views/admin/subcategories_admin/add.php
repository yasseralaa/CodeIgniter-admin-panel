    ...
    <div class="wrapper">
       ...
       <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>index.php/admin/dashboard" class="logo">
          ...
          <span class="logo-mini"><b>Wed</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Wed</b>ian</span>
        </a>
...
<?php echo validation_errors('<p class="alert alert-dismissable alert-danger">'); ?>
 ...
 <?php endif; ?>
           <form method="post" action="<?php echo base_url(); ?>index.php/admin/subcategories_admin/add" enctype="multipart/form-data">
				  <div class="row">
				  <div class="col-md-6">
				  </div>
					<div class="col-md-6">
